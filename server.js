...
// (WhatsCoolAbout self-serve lives in its own app on the root domain now.)
...
// --- Root: the general site lives on the root domain ------------------------
app.get('/', (req, res) => res.redirect(302, 'https://whatscoolabout.com/'));
